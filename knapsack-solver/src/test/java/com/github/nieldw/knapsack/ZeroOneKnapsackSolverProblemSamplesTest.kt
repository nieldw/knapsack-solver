...
class ZeroOneKnapsackSolverProblemSamplesTest {
    ...
    fun `solve sample problem 1`() {
        ...
        val solution = solver.solve(KnapsackProblem(weight("81"), items)).items
    ...
    fun `solve sample problem 2`() {
        ...
        val solution = solver.solve(KnapsackProblem(weight("8"), items)).items
    ...
    fun `solve sample problem 3`() {
        ...
        val solution = solver.solve(KnapsackProblem(weight("75"), items)).items
    ...
    fun `solve sample problem 4`() {
        ...
        val solution = solver.solve(KnapsackProblem(weight("56"), items)).items
        assertEquals(2, solution.size)
